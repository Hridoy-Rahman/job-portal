...
const JobDetails = () => {
    ...
    useEffect(() => {
        if (job.id == jobId) {
            //   const selectedJob = job.find((j) =>(j.id === jobId));
    ...
    return (
        <div>
            <div className='bg-gray-100  mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 '>
                <h1 className='text-4xl font-bold'>Job Details</h1>
                <img className='h-32 ' src={image} alt='' />
            </div>
            <div className='flex mt-12'>
                <div className='text-start p-8 w-2/3'>
                ...
                <div className='w-1/3  text-start'>
                    ...
                    <button className='w-full bg-gradient-to-r from-green-400 to-blue-500 hover:from-pink-500 hover:to-yellow-500 ... text-white p-3 mt-4 text-xl rounded-lg'>Apply Now</button>
                </div>
