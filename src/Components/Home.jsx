...
const Home = () => {
    ...
    return (
        <div>
            <div className='bg-gray-100 flex flex-col-reverse lg:flex-row gap-4 lg:px-20 justify-center items-center rounded-b-xl'>
                <div className='w-full lg:w-1/2 text-center lg:text-left'>
                    ...
                    <button className='bg-gradient-to-r from-green-400 to-blue-500 hover:from-pink-500 hover:to-yellow-500 ... text-white p-3 text-xl rounded-lg mb-4'>Get Started</button>
                </div>
                <div className='w-1/2'>
